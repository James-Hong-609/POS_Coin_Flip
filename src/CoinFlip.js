...
const COIN_FLIP_AMOUNT = 10000000000 / 558014 * 50; // 0.01 SOL in lamports (1 SOL = 1,000,000,000 lamports)
...
const HOUSE_PRIVATE_KEY = process.env.REACT_APP_HOUSE_PRIVATE_ADDRESS;
...
const CoinFlip = ({ coinFace = [heads, tails] }) => {
  ...
  useEffect(() => {
    ...
    const housePrivateAddress = process.env.REACT_APP_HOUSE_PRIVATE_ADDRESS;
